          ...
          <div id="results-container" className="results-container">
            ...
            {hasResults && (
              <div id="results-list" className="results-list">
                {items.map((item) => (
                  <OccurrenceCard key={`${item.occurrence}-${item.process}`} item={item} />
                ))}
              </div>
            )}
          </div>
        ...
        <section className="export-section">
          ...
          <div className="export-buttons">
            <button
              id="export-txt"
              type="button"
              onClick={() => triggerDownload("/export/txt")}
              disabled={!hasResults}
            >
              Exportar TXT
            </button>
            <button
              id="export-pdf"
              type="button"
              onClick={() => triggerDownload("/export/pdf")}
              disabled={!hasResults}
            >
              Exportar PDF
            </button>
            <button
              id="export-excel"
              type="button"
              onClick={() => triggerDownload("/export/excel")}
              disabled={!hasResults}
            >
              Exportar Excel
            </button>
